...
languages.sql = {
  ...
  keyword:
    /\b(?:ABORT|ACTION|ADD|AFTER|ALL|ALTER|ANALYZE|ANY|AS|ASC|ATTACH|AUTOINCREMENT|BEFORE|BEGIN|BIGINT|BINARY|BLOB|BOOLEAN|BY|CASCADE|CASE|CAST|CHECK|COLLATE|COLUMN|COMMIT|CONFLICT|CONSTRAINT|CREATE|CROSS|CURRENT_DATE|CURRENT_TIME|CURRENT_TIMESTAMP|DATABASE|DATE|DATETIME|DECIMAL|DEFAULT|DEFERRABLE|DEFERRED|DELETE|DESC|DETACH|DISTINCT|DOUBLE PRECISION|DROP|EACH|ELSE|END|ESCAPE|EXCEPT|EXCLUSIVE|EXISTS|EXPLAIN|FAIL|FETCH|FIRST|FLOAT|FOR|FOREIGN|FROM|FULL|FUNCTION|GROUP|HAVING|IF|IGNORE|IMMEDIATE|INDEX|INDEXED|INITIALLY|INNER|INSERT|INSTEAD|INT|INTEGER|INTERSECT|INTO|ISNULL|JOIN|JSON|KEY|LEFT|LIMIT|MEDIUMINT|MINUS|NATURAL|NO|NOCASE|NOTNULL|NULL|NUMERIC|OF|OFFSET|ON|ORDER|OUTER|PLAN|PRAGMA|PRIMARY|QUERY|RAISE|REAL|RECURSIVE|REFERENCES|REINDEX|RELEASE|RENAME|REPLACE|RESTRICT|RETURNS|RIGHT|ROLLBACK|ROW|ROWNUM|RTRIM|SAVEPOINT|SELECT|SET|SMALLINT|TABLE|TEMP|TEMPORARY|TEXT|THEN|TIME|TIMESTAMP|TINYINT|TO|TOP|TRANSACTION|TRIGGER|UNION|UNIQUE|UPDATE|USING|UUID|VACUUM|VALUES|VARBINARY|VARCHAR|VIEW|VIRTUAL|WHEN|WHERE|WITH|WITHOUT|XML)(?=\b)/i,
