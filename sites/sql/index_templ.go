...
func inner() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</span></a> where the data has well-defined relationships.</p><p><em>More SQL Please</em> is designed to be a simple, readable introduction to the SQL language and some related database concepts. It uses statements that have been run against <a href=\"https://www.sqlite.org\">SQLite<span>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = st.Outlink().Render(ctx, templ_7745c5c3_Buffer)
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</span></a> databases. Each section utilizes a particular set of database tables which can be shown or hidden at the top of the page anytime.</p><p>If you want to run the examples yourself, <a href=\"https://sqlite.org/download.html\">download SQLite<span>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = st.Outlink().Render(ctx, templ_7745c5c3_Buffer)
